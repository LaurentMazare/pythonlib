...
type t = { foo : string; bar : (int * float) list } [@@deriving python]
...
let callback =
  let%map_open fn =
    keyword "fn"
      (typerep (Function (Tuple (T2 (Int, String)), String)))
      ~docstring:""
  and arg1 = keyword "arg1" int ~docstring:""
  and arg2 = keyword "arg2" string ~docstring:"" in
  fn (arg1, arg2) |> python_of_string
...
let () =
  ...
  Py_module.set mod_ "callback" callback;
