...
module Param : sig
  ...
  val keyword :
    ?default:'a -> string -> 'a Of_python.t -> docstring:string -> 'a t
  ...
  val one_or_tuple_or_list_relaxed :
    'a Of_python.t -> 'a Or_error.t list Of_python.t

  val dict :
    key:'a Of_python.t -> value:'b Of_python.t -> ('a * 'b) list Of_python.t
end
